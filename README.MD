...
csv-parse, utilizando o exemplo de iterador async.
...
stream-http-server.js, nas aulas, utilizando o for await, também é possível fazer com o parse da lib informada acima. (Lembre-se de pular a primeira linha do CSV)
...
Como baixar e roda ro projeto

1 - Realize o clone do projeto (git clone https://github.com/joaopedrovidal/CRUD-tarefas.git)
2 - Abra dois terminais diferentes em sua IDE;
3 - Execute npm install;
4 - Execute npm run dev;
5 - No outro temrinal, navegue até a pasta UTILS e execute node import-csv.js
6 - Consuma todas as rotas da aplicação.
